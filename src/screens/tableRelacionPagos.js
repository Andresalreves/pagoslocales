                            ...
                            return  <tr key={key}>
                                      {
                                        props.td.map((row2,key2)=>{
                                          return <td key={key2}>
                                                  {
                                                    (row2.value!=="events")?<div className={(row2.className!=="estatus")?row2.className:row2.className+row.estatus_string}><div>{(row[row2.value]!=='Realizado')?row[row2.value]:"Acreditado"} </div></div>:<div className="d-flex justify-content-center">
