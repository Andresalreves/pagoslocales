...
const App=(props)=>{
  ...
  let limit2                                =   parseInt(props.limit);
  ...
  const getInit=()=>{
    ...
    let data_                  =   {}
        ...
        data_.filter           =   filter
        data_.estatus          =   (props.estatus!==undefined?props.estatus.estatus:2)
                            ...
                            return  <tr key={key}>
                                      {
                                        props.td.map((row2,key2)=>{
                                          return <td key={key2}>
                                                  {
                                                    (row2.value!=="events")?<div className={props.td.length===key2+1?"text-center":row2.className!==undefined?row2.className:""}><div className={key2===0?"text-dark":row2.className!==undefined?row2.className:""}>{row[row2.value]}</div></div>:<div className="d-flex justify-content-center">
                                                        ...
                                                        return  <div key={key3} className="p-1 " title={row3.label}>
                                                                  {
                                                                    ...
                                                                    {
                                                                      <row3.NavLink className="" to={row3.url+row.pagador_id}>
                                                                        {row3.icon}
                                                                      </row3.NavLink>
                                                                    }
                                                                  </>:<>
