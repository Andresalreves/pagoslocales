                                ...
                                <div className="col-md-10 ml-auto mr-auto mt-3">
                                  <Header title="Resumen"
                                    ...
                                    <div className="mt-2 p-3">
                                      <DocumentosSoporte delete="VerificarDatosReporte_" user={data} setReset={setReset} id={parametros.id}/>
                                    </div>
                                    <Header2 title="Comentarios" classIcon="icon-mensaje-notificacion ico-generico" class="text-left"/>
                                    {!reset?<Comentarios  id={parametros.id}/>:false}
                                    <div className="text-center mt-4">
                                        ...
                                        <div className="btn btn-gray text-white mb-3" onClick={()=>window.history.back()}>Volver</div>
                                    </div>
                                </div>
                            </div>
                        </div>
