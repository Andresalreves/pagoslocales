                    ...
                    <div className="card-content">
                      <div className="card-body perfil">
                          ...
                          <div className="p-5">
                            ...
                            <div className="row mt-3 justify-content-center">
                              <div className="col-12 col-md-5 pt-2">
                                <div className="label"><b>Tipo de Identificación</b></div>
                            ...
                            <div className="mt-2">
                              <DocumentosSoporte id={"VerUsuarios_"+params.usuario_id} id={params.usuario_id}/>
                            </div>
                            ...
                            <Comentarios id={"VerUsuarios_"+params.usuario_id}/>
                            ...
                            <div className="row text-center mt-4 justify-content-center">
                              <div className="col-6">
                                <a target="_blank" href={Config.ConfigApirest+"PDF/Administracion/getUsuario?usuario_id="+params.usuario_id+"&token="+Store.get("user").token} className="btn btn-outline-primary2 mb-3 mr-1">Descargar</a>
                                <NavLink to="/Administracion/Usuarios" className="btn btn-primary mb-3">Ver listado de usuarios</NavLink>
                              </div>
                            </div>
                          </div>
                      </div>
