  ...
  let tds       =   [
    ...
    },
    {
      ...
      icons:[
              ...
              {
                label:"Aprobar",
                icon: <i className = "icon-check mr-1  text-success"/>,
                NavLink:NavLink,
                url:'/Administracion/AprobarOrdenesNacionales/',
              },
              {
                label:"Rechazar",
                icon: <i className = "icon-anular-rechazar mr-1  text-danger"/>,
                NavLink:NavLink,
                url:'/Administracion/EliminarOrdenesNacionales/',
              },
            ]
    },
  ]
