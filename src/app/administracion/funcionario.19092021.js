                        ...
                        <div className="p-5">
                          ...
                          <div className="row mt-3 justify-content-center">
                            <div className="col-12 col-md-5 pt-2">
                              ...
                              <div className="label text-gray">
                                <input  className="form-control"
                                        ...
                                        defaultValue={(data.nombre_completo!==undefined)?data.nombre_completo:""}
                                        onChange={onChange}
                                        event='sololetras'
                                />
                              </div>
                            ...
                            <div className="col-12 col-md-5 pt-2">
                              ...
                              <input  className="form-control"
                                      ...
                                      defaultValue={test?"":data.fecha_nacimiento}
                          ...
                          <div className="row mt-3 justify-content-center">
                            ...
                            <div className="col-12 col-md-5 pt-2">
                              ...
                              <div className="label text-gray">
                                {data.lugar_nacimiento!==undefined && !editLugar?<div onClick={()=>{setEditLugar(true);}}>{data.lugar_nacimiento}</div>:<ReactSearchAutocomplete
