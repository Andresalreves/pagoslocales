...
const test      = true
const opciones  = [ {label:"Cuentas bancarias activas",value:2},
                    {label:"Cuentas bancarias inactivas",value:1}]
  ...
  let tds       =   [
    ...
    },
    {
      ...
      icons:[
              ...
              {
                label:filter.estatus===2?"Inactivar":"Activar",
  ...
  return  <div className="Contenido-Home">
            <div className="row">
              ...
              <div className="col-12 col-md-6 text-right">
                <NavLink className="btn btn-primary" to="/Administracion/createCuentasBancarias">
