                              ...
                              {data?<>
                                ...
                                <div className="row ">
                                    <div className="col-md-6 mt-3">
                                        ...
                                        <div className="col-md-12 mt-2 pl-0 d-flex">
                                            {data.concepto!=='TRANSFERENCIA A BOLSILLO'?<div>
                                                <div className="label"><b>Entidad Bancaria</b></div>
                                                <div className="label text-gray">
                                                  <b>
                                                    {data.banco_string!==undefined && data.banco_string!==''&& data.banco_string!==null?data.banco_string:data.receptor_real && data.receptor_real.banco_string?data.receptor_real.banco_string:"pagoslocales"}
                                                  </b>
                                                </div>
                                            </div>:<div>
                                                <div className="label"><b>BOLSILLO</b></div>
                                                <div className="label text-gray">
                                                  <b>
                                                    {data.cuenta_origen_object.nombre_bolsillo}
                                                  </b>
                                                </div>
                                            </div>}
                                        ...
                                        <div className="col-md-12 mt-2 pl-0 d-flex">
                                            {
                                              data.concepto!=='TRANSFERENCIA A BOLSILLO'?<div>
                                                ...
                                                <div className="label"><b>Valor transferencia</b></div>
                                                <div className="label text-gray"><b>{data.saldo_string} COP</b></div>
                                              </div>
                                            }
                                        </div>
                                        <div className="col-md-12 mt-2 pl-0 d-flex">
                                            <div>
                                                ...
                                                {parseInt(Store.get("user").tipo_usuario_id)<4?<>
                                                  {data.relacion.TRANSACCION!==null?<>
                                                    <div className="label text-gray"><b>
                                                      {data.relacion!==undefined && data.relacion.COMISION_TRANSACCIONAL!==undefined?<>
                                                          {data.relacion.COMISION_TRANSACCIONAL.label}
                                                        </>:data.relacion.COMISION_TRANSACCIONAL===undefined && data.comision_string!==undefined?<>
                                                          {data.comision_string}
                                                        </>:"0.00"}
                                                      COP</b></div>
                                                    </>:<>
                                                    <div className="label text-gray">
                                                      <b>
                                                        {data.comision_string!==undefined?data.comision_string:"0.00"} COP
                                                      </b>
                                                    </div>
                                                  </>}
                                                  ...
                                                  {data.relacion.TRANSACCION!==null?<>
                                                      <div className="label text-gray">
                                                        <b>{data.relacion!==undefined && data.relacion.COMISION_TRANSACCIONAL!==undefined?data.relacion.COMISION_TRANSACCIONAL.label:data.relacion.COMISION_TRANSACCIONAL===undefined  && data.comision_string!==undefined?data.comision_string:"0.00"} COP</b>
                                                      </div>
                                                    </>:<>
                                                    <div className="label text-gray"><b>
                                                      {data.comision_string!==undefined?data.comision_string:"0.00"} COP</b>
                                                    </div>
                                                  </>}
                                                </>:  <>
                                                        <div className="label text-gray">
                                                          <b>{  data.relacion!==undefined &&
                                                                data.relacion.COMISION_TRANSACCIONAL &&
                                                                data.relacion.COMISION_TRANSACCIONAL.label?data.relacion.COMISION_TRANSACCIONAL.label:"0.00"} COP</b>
                                                        </div>
                                                      </>
                                                }
                                                </div>
                                                  ...
                                                  <div className="label text-gray">
                                                    <b>
                                                        {   data.relacion!==undefined &&
                                                            data.relacion.IVA_COMISION_TRANSACCIONAL &&
                                                            data.relacion.IVA_COMISION_TRANSACCIONAL.label?data.relacion.IVA_COMISION_TRANSACCIONAL.label:"0.00"} COP
                                                    </b>
                                                  </div>
                                                </>}
                                            </div>
                                          ...
                                          <div>
                                              ...
                                              {parseInt(Store.get("user").tipo_usuario_id)<4?<>
                                                ...
                                                <div className="label text-gray">
                                                  <b>  {   data.relacion!==undefined &&
                                                        data.relacion.GMF &&
                                                        data.relacion.GMF.label?data.relacion.GMF.label:"0.00"}  COP
                                                  </b>
                                                </div>
                                              </>}
                                ...
                                <div className="text-right mt-4">
                                    <div className="btn btn-outline-primary2 mb-3 mr-1"
                                      onClick={()=>open(Config.ConfigApirest+"PDF/Movimientos/getMovimiento?skip=true&transferencias_id="+parametros.transferencias_id+"&token="+Store.get("user").token)}>
                                      Descargar
                                    </div>
                                    <NavLink to={"/Movimientos/DetalleBilletera/"+parametros.cuenta_id} className="btn btn-primary text-white mb-3">Volver</NavLink>
                                </div>
