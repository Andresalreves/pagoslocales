...
class Grabador extends Component {
  ...
  btn_microfono_grabar(){
    return <FontAwesomeIcon onClick={this.handleAction} id="btn_microfono_iniciar" icon={faMicrophone} className={""}/>
  }

  btn_microfono_detener(){
    return <FontAwesomeIcon onClick={this.handleAction} id="btn_microfono_detener" icon={faStop} className={""}/>
  }
  ...
  render() {
    return  <div id="action" className="ico-content m-0 ml-1">
