...
const App=()=>{
  ...
  const CallExcel = () =>{
    ...
    window.open(Config.ConfigApirest+'Excel/Movimientos/getMovimientosBilletera/token:'+send.token+'/id_billetera:'+data.id_billetera);
  }
  let tds       =   [
    {
      label:"Estado",
  ...
  const getInit=()=>{
    Functions.PostAsync('Movimientos','getBilletera',params,{},{name:"callbackContinue",funct:callbackContinue})
  }
                ...
                <div className="card">
                          ...
                          {data.saldo_string?<>
                            ...
                            <div className="col-12 col-sm-2 text-right ">
                              <FontAwesomeIcon  icon={faFilePdf}
                                                className=" icon-comentarios cursor-pointer mr-2 text-white"
                  ...
                  <div className="card-body">
                    <Table
                      ...
                      limit="20"
                      filter={1}
                      id_billetera={params.id_billetera}
                    />
                  </div>
                </div>
              </div>
