                                            ...
                                            <div className="col-md-10 ml-auto mr-auto mt-3">
                                              <Header title="Resumen"
                                                ...
                                                <div className="text-center mt-4">
                                                    <a target="_blank" href={Config.ConfigApirest+"PDF/Divisas/getReporte?id="+data.token_reporte_pago+"&token="+Store.get("user").token} className="btn btn-outline-primary2 mb-3 mr-1">Descargar</a>
